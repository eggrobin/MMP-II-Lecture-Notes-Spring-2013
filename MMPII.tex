...
\newcommand\greek[1]{{\selectlanguage{polutonikogreek} \textbodoni{#1}}}
...
\begin{supplemental}
\subsection{\greek{Ἡ φανταχτερή γλῶσσα τῶν ἀστικῶν μαθηματικῶν}\footnote{The fancy language of bourgeois mathematicians.}}
\begingroup
...
If $G$ is a connected abelian Lie Group, it can be shown that it is the direct product of a finite dimensional $\R$-vector space and a torus, i.e., $G\Isomorphic \Rn \DirectProduct \Torus m$ for some $m,n \in \N$.
We will show in the examples below that for $G=\Rn$ and $G=\UnitSphere 1 = \Torus 1$, the Pontryagin dual\footnote{The Pontryagin dual is named after %\russian{Лев Семёнович Понтря́гин} 
Lev Semenovich Pontryagin (1908--1988).} $\PontryaginDual G$ is isomorphic to $\MomentumSpace$.
\endgroup
\end{supplemental}
