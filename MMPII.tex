...
\begin{document}
  ...
  \begin{lemma}[``Your life in Fourier land depends on it.'']
    ...
    \begin{proof}
      ...
      \begin{align*}
        ...
        &= \ftnrm\Int\Rn\gj\of*\by\E^{-\I\scal*{\frac 1\gl\bk}{\by}} \diffd\of*{\frac{\by}{\gl}}
      ...
      \begin{align*}
        ...
        &= \Int\Rn\ftnrm\Int\Rn\gj\of*\bx
          \E^{-\I\scal*\by\bx}\diffd\bx\:\gy\of*\by\diffd\by \\
        &= \Int\Rn\gj\of*\bx\ftnrm\Int\Rn
  ...
  \begin{proposition}
  The Fourier transform $\ft\quad$ is a continuous bijective linear map from the Schwartz space $\Schwartz$ to itself. $\rft{\ft{\gj}}=\gj$, where $\rft\gy\of*\bx\coloneqq\ftnrm \int_\Rn\gy\of*\bk\E^{\I\scal*\bk\bx}\diffd\bx$, read ``unhat'', ``bird'', ``seagull'', or whatever you like.
